...
class Board(QMainWindow):                #beliz
    ...
    def display(self, game): 
        ...
        #titel
        self.setWindowTitle("m, n, k Game")
...
if __name__ == "__main__":
    ...
    #definieren Spieler
    player_mensch = Player("Florian", "x")
    player_mensch2 = Player("David", "o") 
    ...
    num_games = 200  # Anzahl der Spiele
...
#-----------------------------------------------------------------------------------------------------------
    ...
    if play_several_times:                                           #mehrere male durchlaufen --> für Data Science Fragen
        for _ in range(num_games):                                   #für jedes game einmal die Schleife durchlaufen,a
            ...
            game = Game(3, 3, 3, player1, player2)
        ...
        for k in range(6):              
            ...
            for i in range(1):
                ...
                for e in range(1000):                          #1000 Spiele pro paar
                    game = Game(3, 3, 3, player1f, player2f)   #game klasse aufrufen 
